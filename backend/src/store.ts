...
export const listings: Listing[] = [
  {
    ...
    image: 'https://images.unsplash.com/photo-1567306301408-9b74779a11af?auto=format&fit=crop&q=80&w=1000',
    totalQuantity: 10,
    unit: 'kg',
    availableQuantity: 8.5,
    harvestType: 'pickup',
    pickupTimes: 'Mo-Fr ab 17 Uhr',
    location: { x: 30, y: 40, address: 'Gartenweg 3' },
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1506917728037-b6af011561e2?auto=format&fit=crop&q=80&w=1000',
    totalQuantity: 20,
    unit: 'Stück',
    availableQuantity: 12,
    harvestType: 'self_harvest',
    pickupTimes: 'Wochenende ganztägig',
    location: { x: 60, y: 25, address: 'Am Feldrain 9' },
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1596486489709-7dc8e31399db?auto=format&fit=crop&q=80&w=1000',
    totalQuantity: 50,
    unit: 'Bund',
    availableQuantity: 50,
    harvestType: 'pickup',
    pickupTimes: 'Jederzeit an der Pforte',
    location: { x: 35, y: 45, address: 'Gartenweg 3' },
